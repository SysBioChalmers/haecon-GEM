...
%Filling gaps in the model HaeconGEM07
...
haecon_model = load('model/Haecon_GEMv07.mat')

haecon_model = haecon_model.haecon_model

%Some manipulation i did using cobrapy changed the structure.
% So i made this cobra - Raven converter
haecon_model = convertCobraToRaven(haecon_model)
...
save('model/Haecon_GEMv08.mat','Model3')